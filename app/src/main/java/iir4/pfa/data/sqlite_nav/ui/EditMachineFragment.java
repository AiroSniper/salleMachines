...
public class EditMachineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        spinner = v.findViewById(R.id.edit_s_salle);
        ref = v.findViewById(R.id.edit_m_ref);
        marque = v.findViewById(R.id.edit_m_marque);
        edit_machine = v.findViewById(R.id.btn_edit_machine);
        ...
        Machine machine = m_service.findById(id);

        spinner.setSelection(adapter.getPosition(machine.getSalle().getCode()));
        ...
        edit_machine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                m_service.update(new Machine(id,marque.getText().toString(),ref.getText().toString(), s_service.findByCode(spinner.getSelectedItem().toString())));
              /*  marque.setText("");
                ref.setText("");
                spinner.setSelection(0);*/
                Toast.makeText(getParentFragment().getActivity().getApplicationContext(), "LA MACHINE EST MODIFIEE AVEC SUCCEE", Toast.LENGTH_SHORT).show();
            }
        });
        return v;
